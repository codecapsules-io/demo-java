...
<h1 align="center">
  How to deploy a Java application to production
</h1>
...
This is the code to accompany the tutorial available in our deployment guide [How to deploy a Java application to production](https://codecapsules.io/docs/deployment/how-to-deploy-java-application-to-production/).
